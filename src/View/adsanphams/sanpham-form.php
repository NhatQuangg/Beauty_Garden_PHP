...
<!-- Nút để hiển thị form thêm sản phẩm -->
 <style>
    ...
    <!-- <h1>User Form</h1> -->
    <form id="Form" action="/sanpham/<?= "update/$sanpham[masanpham]"  ?>" method="post" class="mb-3" style="margin: 20px;">
    <!-- Các trường của form -->
    <div class="form-row align-items-end">
        <div class="form-group col-md-4" style="margin-bottom: 20px;">
            <label for="masanpham">Mã sản phẩm:</label>
            <input type="text" id="masanpham" name="masanpham" class="form-control" value="<?= isset($sanpham['masanpham']) ? $sanpham['masanpham'] : '' ?>" readonly required>
        </div>
        <div class="form-group col-md-4" style="margin-bottom: 20px;">
        ...
        <div class="form-group col-md-4" style="margin-bottom: 20px;">
            ...
            <input type="text" id="soluong" name="soluong" class="form-control" value="<?= isset($sanpham['soluong']) ? $sanpham['soluong'] : '' ?>" required>
        </div>
        <div class="form-group col-md-4" style="margin-bottom: 20px;">
            <label for="gia">Giá:</label>
            <input type="text" id="gia" name="gia" class="form-control" value="<?= isset($sanpham['gia']) ? $sanpham['gia'] : '' ?>" required>
        </div>
        <div class="form-group col-md-4" style="margin-bottom: 20px;">
        ...
        <div class="col-md-12 mt-3 d-flex justify-content-end" style="margin-right: 30px;">
         ...
         <input type="submit" value="<?= isset($sanpham['masanpham']) ? 'update': 'add' ?>">
        </div>
    </div>
</form>
